  ...
  head: () => ({
    meta: [
      { title: "About — The Zero Restaurant, Dhaka" },
      {
        name: "description",
        content:
          "The story behind The Zero — a warm two-floor family restaurant in the BAFWWA Shopping Complex, Dhaka.",
      },
...
const values = [
  { icon: Heart, title: "Hospitality first", text: "Every guest is welcomed like family." },
  {
    ...
    text: "Fresh produce, real spices, no shortcuts.",
  },
  {
    icon: Users,
    title: "A place to gather",
    text: "Designed for long evenings with friends and family.",
  },
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      <header className="max-w-3xl">
        <p className="animate-fade-up text-xs uppercase tracking-[0.4em] text-primary">
          Taste the Art
        </p>
        <h1
      ...
      <Reveal>
        <figure className="img-zoom mt-12 rounded-3xl border border-border shadow-warm">
          <img
            src={storefrontNight}
            alt="The Zero storefront in Dhaka, lit up at night"
      ...
      <div className="mt-16 grid items-start gap-12 md:grid-cols-2">
        <Reveal>
          <div className="img-zoom rounded-2xl shadow-warm">
            <img
              src={interiorStairs}
              alt="Inside The Zero — main dining room with feature staircase"
              width={1400}
              height={900}
              loading="lazy"
        ...
        <Reveal delay={150}>
          <div className="space-y-5 text-base leading-relaxed text-muted-foreground">
            <p>
              The Zero began with a simple idea — a neighbourhood restaurant where the food is bold,
              the welcome is warm, and the experience feels effortlessly right.
            </p>
            <p>
              Spread across two floors of the BAFWWA Shopping Complex on Bir Uttam Ziaur Rahman
              Road, our dining room blends comfortable sofa seating with classic dining tables, soft
              amber lighting and a dedicated smoking zone.
            </p>
            <p>
              From flame-grilled peri-peri chicken to molten lava cake, every plate is built around
              real ingredients and the kind of care that only a family-run kitchen can give.
            </p>
          </div>
        </Reveal>
      </div>
      ...
      <section className="mt-24">
        <Reveal>
          <h2 className="font-display text-4xl">Step inside</h2>
        </Reveal>
        ...
        <section className="mt-24 overflow-hidden rounded-3xl border border-border">
          <div className="grid md:grid-cols-2">
            <div className="img-zoom">
              <img
                src={spread}
                alt="A table spread at The Zero"
                width={1400}
                height={900}
                loading="lazy"
                className="h-full w-full object-cover"
            ...
            <div className="bg-card p-10 md:p-14">
              ...
              <blockquote className="mt-6 border-l-2 border-primary pl-5 text-lg italic text-muted-foreground">
                “The second floor is well-decorated and visually appealing — sofas and chairs both,
                a great place to gather.”
                <footer className="mt-3 text-sm not-italic text-foreground">
                  — Nahian I., Local Guide
                </footer>
              </blockquote>
            </div>
          </div>
