    ...
    <>
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[88vh] max-w-7xl flex-col justify-end px-4 pb-20 pt-32 sm:px-6 md:pb-28 md:pt-40">
          <p className="mb-4 inline-flex items-center gap-2 text-sm uppercase tracking-[0.3em] text-primary">
            <span className="h-px w-10 bg-primary" /> Dhaka · Since day one
          </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {highlights.map((h) => (
            <div key={h.title} className="group rounded-2xl border border-border bg-card p-8 transition-all hover:border-primary/40 hover:shadow-warm">
      ...
      <section className="bg-card/40 py-24">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 md:grid-cols-2">
          <img
            ...
            height={900}
            loading="lazy"
            className="rounded-2xl object-cover shadow-warm"
          />
          <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {popular.map((item) => (
            <div key={item.name} className="rounded-2xl border border-border bg-card p-6 transition-all hover:border-primary/40">
      ...
      {/* CTA */}
      <section className="relative isolate overflow-hidden">
        <img src={spread} alt="A spread of pizza, wings, fries and drinks" width={1400} height={900} loading="lazy" className="absolute inset-0 h-full w-full object-cover opacity-30" />
